...
<div id="submenu">
	<!-- The first sub menu -->
	<div id="submenu_1">
		<a href="javascript:openCal()" >Hyderabad
...
Evening  4 pm
	...
	<!-- Third sub menu -->
	<div id="submenu_3">
		<a href="javascript:openCal()">New Delhi<iframe src="YourFile.txt" 
 style="float: center; 
...
Alternative Content
		...
		<a href="javascript:openCal()">Ottawa</a><br> -->
	</div>
	<!-- Fourth sub menu -->
	<div id="submenu_4">
