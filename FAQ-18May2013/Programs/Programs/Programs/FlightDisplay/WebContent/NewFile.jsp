...
<div id="mainMenu">
<tr>
	<td><br><a>AirIndia</a></td>
	<td><br><a>KingFisher</a></td>
	<td><br><a>BritishAirLines</a></td>
	<td><br><a>AmericanAirLines</a></td>
	</tr>
</div>
</table>
<div id="submenu">
	<!-- The first sub menu -->
	<div id="submenu_1">
	<textarea rows="5" cols="30" style='visibility'>
Flight from Delhi
 to Hyderabad time 
  Morning 10 am
</textarea>
		<a href="javascript:openCal()">Hyderabad</a><br>
		<!--  <a href="javascript:openCal()">Delhi</a><br>
		<a href="javascript:openCal()">Mumbai</a> -->
	</div>
	<!-- Second sub menu -->
	<div id="submenu_2">
		<a href="javascript:openCal()">Mumbai</a><br>
		<a href="javascript:openCal()">Hyderabad</a><br>
		<a href="javascript:openCal()">Bangalore</a>
	</div>
	<!-- Third sub menu -->
	<div id="submenu_3">
		<a href="javascript:openCal()">New Delhi</a><br>
		<a href="javascript:openCal()">Kuala Lumpur</a><br>
		<a href="javascript:openCal()">Tokyo</a><br>
		<a href="javascript:openCal()">Ottawa</a>
	</div>
	<!-- Fourth sub menu -->
	<div id="submenu_4">
